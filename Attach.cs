...
namespace blekenbleu.loaded
{
	public partial class Loaded
	{
		...
		double LPyaw = 0, LPsway = 0, YawSway = 0;	// LPfilter() applied
		double LatAcc, SideSlipAngleRate, LatVel, SwayAccAngle;
		double ACprodFRslip = 0;
		double Loads, Heave, YawVel, YawRate, Steering, SteerPC, Vsway, SlipRate;
		...
		void Attach()
		{
			...
			this.AttachDelegate("SwayAccAngle",	() => SwayAccAngle);
			this.AttachDelegate("SideSlipAngleRate",() => SideSlipAngleRate);
			...
			this.AttachDelegate("YawRate",		() => YawRate);		// OrientationYawVelocity rescaled to SwayAcc
